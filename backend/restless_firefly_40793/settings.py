"""
Django settings for restless_firefly_40793 project.
...
ROOT_URLCONF = 'restless_firefly_40793.urls'
...
WSGI_APPLICATION = 'restless_firefly_40793.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "restless_firefly_40793 API",
    "DESCRIPTION": "API documentation for restless_firefly_40793 App",
    "VERSION": "v1",
}
